using System;
using Iatec.Databases.PeopleMgmt;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata;

namespace Iatec.Databases
{
    public partial class PeopleMgmtDbContext : DbContext
    {
        public PeopleMgmtDbContext()
        {
        }

        public PeopleMgmtDbContext(DbContextOptions<PeopleMgmtDbContext> options)
            : base(options)
        {
        }
